...
////part 2 animation for left swipe and right swipe diffrent
class Part2HomeScreen extends StatefulWidget {
  const Part2HomeScreen({super.key});

  @override
  State<Part2HomeScreen> createState() => _Part2HomeScreenState();
}

class _Part2HomeScreenState extends State<Part2HomeScreen> {
  List<String> images = [
    'assets/1.png',
    'assets/33.jpg',
    'assets/44.jpg',
